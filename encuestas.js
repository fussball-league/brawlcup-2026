...
const TIEMPO_APERTURA_D1 = 1778752800;
const TIEMPO_APERTURA_D2 = 1778857200;
...
const PARTIDAS = [
    {
        ...
        ganador_id: '1213d015-d66c-458e-8d20-909e956e062c',
        visible: false,
    ...
    },
    {
        ...
        ganador_id: 'd21c38ff-1212-43e7-aaf6-6d05e42857a8',
        visible: false,
        apertura: TIEMPO_APERTURA_D1,
        clausura: TIEMPO_CLAUSURA_D1,
        opciones: [
...
function renderizarEncuestas() {
    ...
    // 1. FILTRADO: Solo procesamos partidas donde visible no sea false
    const partidasVisibles = PARTIDAS.filter(p => p.visible !== false);

    // 2. AGRUPACIÓN: Usamos las partidas filtradas para agrupar por día
    const gruposPorDia = partidasVisibles.reduce((acc, partida) => {
            ...
            <table class="tabla-posiciones">
                ...
                <tbody>
                    ${TABLAS_GRUPOS[nombreGrupo].map((e, index) => {
                        // Mantenemos la lógica visual: primeros 2 verde (clasificados), último rojo
